        ...
        <div class="evenementen">
            <div class="row" style="margin-bottom: 10px;">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-12">
                            <input type="text" class="form-control InputFontChangers" onclick="getDuplicateText()"
                                   id="evenement" aria-describedby="evenement"
                                   name="evenement" placeholder="Evenement" required>
                        </div>
                        <!-- <div class="col-md-6"> -->
                        <input type="hidden" class="form-control InputFontChangers" style="background-color: white;"
                               readonly=true id="table_name" name="table_name"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <h6>Begin Datum:</h6>
                            <input id="datum_begin" type="text" class="form-control InputFontChangers"
                                   name="datum_begin"
                ...
                <div class="col-md-6">
                    <div class="form-check">
                        <input class="form-check-input inlineCheckbox1 InputFontChangers" type="checkbox"
                               value="Extra mensen"
                    ...
                    <div class="form-check">
                        <input class="form-check-input inlineCheckbox2 InputFontChangers" type="checkbox"
                               value="Vervoer"
                        ...
                        <div class="vervoer_zelf" style="display: none;">
                            <input type="text" class="form-control InputFontChangers" id="text_vervoer"
                                   name="text_vervoer" placeholder="Tekst voor vervoersmiddel"
                    ...
                    <div class="form-check">
                        <input class="form-check-input inlineCheckbox4 InputFontChangers" type="checkbox" id="check4"
                               name="check4"
                               value="Edities" onClick="showInput3();">
                        <label class="form-check-label" for="check4">Edities</label>

                        <div class="editie" style="display: none;">
                            <input type="text" class="form-control InputFontChangers" id="text_editie"
                                   name="text_editie" placeholder="Tekst voor edities"
                                   style="margin-bottom: 10px;">
                            <div class="row">
                                <div class="col-md-10 columnEditie">
                                    <div class="box">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control InputFontChangers"
                                                       placeholder="Editie"
                ...
                <div class="col-md-6">
                    <div class="form-check">
                        <input class="form-check-input inlineCheckbox5 InputFontChangers" type="checkbox"
                               value="Accomodatie"
                        ...
                        <div class="accomodatie" style="display: none;">
                            <input type="text" class="form-control InputFontChangers" id="text_accomodatie"
                                   name="text_accomodatie"
                    ...
                    <div class="form-check">
                        ...
                        <div class="verhuur" style="display: none;">
                            <input type="text" class="form-control InputFontChangers" id="text_verhuur"
                                   name="text_verhuur" placeholder="Tekst voor verhuur"
                                   style="margin-bottom: 10px;">
                            <div class="row">
                ...
                <div class="col-md-4">
                    <h6>Extra</h6>
                    <input type="text" class="form-control InputFontChangers" id="Prijs" aria-describedby="prijs"
                           placeholder="Prijs"
                           name="prijs" required>
                    <input type="number" class="form-control InputFontChangers" id="max_deelname"
                           placeholder="Max aantal deelnames"
