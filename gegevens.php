                ...
                while ($row = mysqli_fetch_assoc($result)):
                    ...
                    <div class="col-md-5 border gegevens" style="padding: 10px; margin: 15px">
                        ...
                        <form method="get">
                            ...
                            <button value="<?= $row["id"] ?>" type="submit" name="delete_inschrijver"
                    ...
                    <div class="col-md-12 border" style="padding: 10px; margin: 15px; display: none;" id="gegevensEdit">
                        ...
                        <form method="post" action="gegevens.php">
                            ...
                            <input id="telefoonnumer" class="form-control margin_top_10" name="telefoonnummer"
                                   title="telefoonnummer" placeholder="Telefoonnummer">
                            <input id="woonplaats" class="form-control margin_top_10" name="woonplaats"
                                   title="woonplaats" placeholder="Woonplaats">
                            <input id="straat" class="form-control margin_top_10" name="straat" title="straat"
                                   placeholder="Straat">
                            <input id="huisnummer" class="form-control margin_top_10" name="huisnummer"
                                   title="huisnummer" placeholder="Huisnummer">
                            <input id="postcode" class="form-control margin_top_10" name="postcode" title="postcode"
                                   placeholder="Postcode">

                            <div class="text-center">
                                <button value="<?= $_SESSION["id"] ?>" id="save_gegevens" name="save_gegevens"
                                        class="btn btn-success save_gegevens margin_top_10" type="submit">Opslaan
                                </button>
                            </div>
                        </form>
                    </div>
