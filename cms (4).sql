...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 10 jan 2019 om 10:40
...
INSERT INTO `evenementen` (`id`, `evenement`, `datum_begin`, `datum_eind`, `prijs`, `max_deelnemers`, `extra_inschrijven`, `vegetarisch`, `annuleringsverzekering`, `text_extra`, `text_accomodatie`, `text_editie`, `text_verhuur`, `text_vervoer`) VALUES
...
(56, 'Zwemmen in het ijsselmeer', '09-06-2019', '10-06-2019', 900, 2000, 0, '', '', '', '', '', '', '');
